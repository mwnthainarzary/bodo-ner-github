...
MODEL_DIR = "./transformer_ner_law-ai_InLegalBERT"
...
def main():
    ...
    full_evaluation_report(y_true, y_pred, out_dir="eval_transformer_ner_law-ai_InLegalBERT", title="law-ai/InLegalBERT")
